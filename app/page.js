 ...
 <section className="py-12 bg-white dark:bg-gray-900">
  <div className="container px-4 mx-auto">
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full p-4 sm:w-1/2 lg:w-1/3">
        <div className="p-6 text-center transition duration-500 transform bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:scale-105">
          <p className="text-gray-600 dark:text-gray-400">Exceptional service and support. We could not be happier with the results</p>
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full p-4 sm:w-1/2 lg:w-1/3">
        <div className="p-6 transition duration-500 transform bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:scale-105">
          <img src="/typescript.webp" className="object-cover w-full h-64 rounded-t-lg"/>
          <div className="mt-4">
      ...
      <div className="w-full p-4 sm:w-1/2 lg:w-1/3">
        <div className="p-6 transition duration-500 transform bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:scale-105">
          <img src="https://images.pexels.com/photos/1181472/pexels-photo-1181472.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Blog 2" className="object-cover w-full h-64 rounded-t-lg"/>
          <div className="mt-4">
      ...
      <div className="w-full p-4 sm:w-1/2 lg:w-1/3">
        <div className="p-6 transition duration-500 transform bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:scale-105">
          <img src="https://images.pexels.com/photos/3861972/pexels-photo-3861972.jpeg" alt="Blog 3" className="object-cover w-full h-64 rounded-t-lg"/>
          <div className="mt-4">
